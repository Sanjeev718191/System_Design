public class Builder {
    // Instead of using a constructor with many parameters (which can be cumbersome and error-prone), 
    // the Builder pattern allows you to separate the construction process from the final object.
